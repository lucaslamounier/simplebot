...
chats = ['Oi', 'Olá', 'Como você está ?', 'Eu estou bem.', 'Obrigado.'] # conversas

chatterbot.set_trainer(ListTrainer) # define o metodo de treinamento
chatterbot.train(chats) # define a lista de conversas
    ...
    with sr.Microphone() as s:
        ...
        while True:
            try:
                ...
                speech = r.recognize_google(audio, language='pt-BR') # fala
